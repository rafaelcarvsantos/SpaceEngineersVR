...
public class Headset : TrackedDevice
{
	...
	private readonly FastResourceLock renderBodyComponentLock = new();
	...
	public Vector2I rawResolution => new((int)width, (int)height);
	public Vector2I scaledResolution => new((int)(width * Common.Config.resolutionScale), (int)(height * Common.Config.resolutionScale));
