...
public class TrackedDevice
{
	...
	public MatrixAndInvert deviceToPlayer => new(pose.deviceToAbsolute.matrix * Player.PlayerToAbsolute.inverted, Player.PlayerToAbsolute.matrix * pose.deviceToAbsolute.inverted);
