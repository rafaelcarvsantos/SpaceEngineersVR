...
namespace SpaceEngineersVR.Patches
{
	public static class Common
	{
		...
		public static readonly HarmonyMethod Transpiler_ReplaceHeadMatrixWithHandMatrix_Harmony = new HarmonyMethod(typeof(Common), nameof(Transpiler_ReplaceHeadMatrixWithHandMatrix));
